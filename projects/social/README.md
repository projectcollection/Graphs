...
1. To create 100 users with an average of 10 friends each, how many times would you need to call `addFriendship()`? Why?
	...
	average of 500, iterate through 100 users and run it 10 for each. but since, for one call, it will add friendship to user 1 and user 2, we divide by 2 `(100*10)/2` to get an average of 500. (maybe)
